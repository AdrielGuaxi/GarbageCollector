...
/*
Classe que define as funções e caracteristicas que os atores podem ter no jogo, 
como carregar texturas, definir o limite de cada objeto, evitar colisão, fisica e camera.
 */
