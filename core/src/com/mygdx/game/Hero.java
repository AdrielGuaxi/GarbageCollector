...
/*
Classe onde é especificado o comportamento do personagem controlado pelo jogador, 
como a animação para o sprite do mesmo e para onde ele estará apontado e
a fisica aplicada a ele (aceleração, velocidade, desaceleração).
*/
public class Hero extends BaseActor{
    ...
    public Hero(float x, float y, Stage s){
        super(x,y,s); 
        String fileName = "lixeiro_2.0_Rare.png";
        int rows = 4;
        int cols = 4;
